...
def test_analytics_updated_populates_cards_and_leaderboards(window):
    ...
    assert window._analytics_record_card._value_label.text() == "2W / 1L"
    assert window._analytics_winrate_card._value_label.text() == "67%"
    assert window._analytics_duration_card._value_label.text() == "4:52"
    assert window._analytics_overtime_card._value_label.text() == "0W / 1L"
    assert window._analytics_opponents_table.rowCount() == 1
    assert window._analytics_teammates_table.rowCount() == 0
    ...
    assert window._analytics_teammates_empty_lbl.isHidden() is False
    assert window._analytics_opponents_empty_lbl.isHidden() is True


def test_analytics_updated_survives_an_empty_payload(window):
    ...
    window.signals.analytics_updated.emit({})
    assert window._analytics_record_card._value_label.text() == "0W / 0L"
    assert window._analytics_winrate_card._value_label.text() == "—"
    assert window._analytics_duration_card._value_label.text() == "—"
